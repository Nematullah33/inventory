...
class Pos_model extends CI_Model {
		...
		extract($_POST);
		  ...
		  $table='';
	       //$q2=$this->db->query("select b.id as tax_id, a.*,b.tax,b.tax_name,a.tax_type,a.item_image from db_items a,db_tax b where b.id=a.tax_id and a.status=1 $str order by a.stock desc");
	        $q2=$this->db->query("select b.id as tax_id, a.*,b.tax,b.tax_name,a.tax_type,a.item_image from db_items a,db_tax b where b.id=a.tax_id and a.status=1 $str order by a.stock desc  Limit 0,100"); // modified by shahin shaukat 23-Dec-2021  Limit 0,4000 
	      if($q2->num_rows()>0){
	...
	public function get_details1($i_id){
		$CI =& get_instance();
		$data=$this->data;
		extract($data);
		extract($_POST);
		  ...
		  $table='';
	       //$q2=$this->db->query("select b.id as tax_id, a.*,b.tax,b.tax_name,a.tax_type,a.item_image from db_items a,db_tax b where b.id=a.tax_id and a.status=1 $str order by a.stock desc");
	        $q2=$this->db->query("select b.id as tax_id, a.*,b.tax,b.tax_name,a.tax_type,a.item_image from db_items a,db_tax b where b.id=a.tax_id and a.status=1 and a.id='$i_id' $str"); // modified by shahin shaukat 23-Dec-2021  Limit 0,4000 
	      if($q2->num_rows()>0){
	        foreach($q2->result() as $res2){
	        	$item_tax_type = $res2->tax_type;
	        	$item_tax_id = $res2->tax_id;
