      ...
      <div class="row">
        ...
        <div class="col-md-5">
          ...
          <div class="box box-info">
            ...
            <input type="hiddhen" value="<?php //echo $CI->get_details1($item_id);?>">  
...
function get_details1($id){
  $(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
  $.post("<?php echo $base_url; ?>pos/get_details1",{id:$("#category_id").val()},function(result){
    $(".search_div").html('');
    $(".search_div").html(result);
    $(".overlay").remove();
  });
...
function addrownotfound(id){
       
        $.ajax({
            autoFocus:true,
            url: $("#base_url").val()+'items/get_json_items_details_ext',
            method: 'GET',
            dataType: 'json',
          ...
          var rowcount        =$("#hidden_rowcount").val();//0,1,2...
          var item_id         =res[0].id;
          var item_name       =res[0].value;
