  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <?php if ($CI->permissions('sales_add')  || $CI->permissions('sales_view') || $CI->permissions('sales_return_view') || $CI->permissions('sales_return_add')) { ?>
        <li class="pos-active-li sales-list-active-li sales-active-li sales-return-active-li sales-return-list-active-li treeview">
          <a href="#">
            <i class=" fa fa-shopping-cart text-aqua"></i> <span><?= $this->lang->line('membership'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <?php if ($CI->permissions('sales_add')) { ?>
              ...
              <li class="sales-active-li"><a href="<?php echo $base_url; ?>membership/add"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('new_membership'); ?></span></a></li>
            <?php } ?>

            <?php if ($CI->permissions('sales_view')) { ?>
              <li class="sales-list-active-li"><a href="<?php echo $base_url; ?>membership"><i class="fa fa-list "></i> <span><?= $this->lang->line('membership_list'); ?></span></a></li>
            <?php } ?>
