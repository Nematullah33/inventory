$('#save,#update').click(function(e) {
    ...
    if (this_id == "save") //Save start
    {
        ...
        if (confirm("Do You Wants to Save Record ?")) {
            e.preventDefault();
            data = new FormData($('#members-form')[0]); //form name
            /*Check XSS Code*/
            console.log(data);
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result == "success") {
                        ...
                        window.location = base_url + "membership";
                        return;
    ...
    else if (this_id == "update") //Update start
    {
        ...
        if (confirm("Do You Wants to Save Record ?")) {
            ...
            $.ajax({
                type: 'POST',
                url: base_url + 'membership/update_members',
                data: data,
                cache: false,
                contentType: false,
                processData: false,
...
function update_status(id, status) {
    ...
    $.post("membership/update_status", { id: id, status: status }, function(result) {
        if (result == "success") {
            toastr["success"]("Record Updated Successfully!");
